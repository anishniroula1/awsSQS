...
class FunctionCallTracer:
    ...
    def trace_calls(self, frame, event, arg):
        ...
        # Handle class methods - include class name
        if 'self' in locals_dict:
            cls_name = locals_dict['self'].__class__.__name__
            # Add class name to function name for better visualization
            func_id = f"{func_filename}:{cls_name}.{func_name}:{line_no}"
...
<body>
    <div class="container">
        ...
        <div class="legend">
            ...
            <div class="legend-item">
                <div class="legend-color" style="background-color: #9334e6;"></div>
    ...
    <script>
        ...
        document.getElementById("resetBtn").addEventListener("click", () => {
            ...
            node.selectAll("circle").attr("r", 10).attr("stroke-width", 2);
        ...
        document.getElementById("searchInput").addEventListener("input", function() {
            ...
            node.each(function(d) {
                ...
                nodeElement.style("opacity", isMatch || searchTerm === "" ? 1 : 0.2);
            });
            
            link.style("opacity", searchTerm === "" ? 0.6 : 0.1);
        });
        ...
        function highlightConnections(selectedNode) {
            ...
            node.filter(d => linkedNodeIds.has(d.id))
                .select("circle")
                .attr("r", 12)
                .attr("stroke-width", 2);
            ...
            node.style("opacity", d => 
                d.id === selectedNode.id || linkedNodeIds.has(d.id) ? 1 : 0.3
            );
