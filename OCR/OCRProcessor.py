...
class OCRProcessor:
    ...
    def __correct_image_alignment(self, image, image_processor: ImageProcessing):
        """
    ...
    def __pil_page_to_text(self, page, return_confidence=True):
        """
    ...
    def execute_ocr_process(self, pdf_bytes):
        ...
        try:
            ...
            for index, image in enumerate(image_processor.pdf_to_images(pdf_bytes)):
                ...
                corrected_image = self.__correct_image_alignment(image, image_processor)
                full_text, ocr_confidences = self.__pil_page_to_text(
